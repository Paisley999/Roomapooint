            ...
            <el-container>
                <el-aside width="200px">
                    ...
                    <el-menu class="menu-list" :router="true" active-text-color="#28b2d4">
                        ...
                        <el-menu-item index="/Admin/IntegralMallAdmin">
                            <i class="el-icon-s-shop"></i>
                            <span>积分商城</span>
                        </el-menu-item>
                        <el-menu-item index="/Admin/LostFoundList">
                        ...
                        <el-menu-item @click="goToCustomerService">
...
export default {
    ...
    methods: {
        ...
        goToCustomerService() {
            window.open('https://chat.twt.com/workspace/home', '_blank');
        }
    }
}
</script>
